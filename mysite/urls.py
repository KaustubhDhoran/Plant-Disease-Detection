...
urlpatterns = [
    path('admin/', admin.site.urls),
                  ...
                  path('view_plant_disease_guide', view_plant_disease_guide, name="view_plant_disease_guide"),
                  path('view_supplements', view_supplements, name="view_supplements"),  
                  ...
                  path('view_feedback', View_Feedback, name="view_feedback"),
                   path('view_search_pat_final', View_Search_Pat_Final, name="view_search_pat_final"),
                  ...
                  path('delete_searched/<int:pid>', delete_searched, name="delete_searched"),
                   path('delete_searched_final/<int:pid>', delete_searched_final, name="delete_searched_final"),
                  ...
                  path('plant_disease_detection', plant_disease_detection, name="plant_disease_detection"),

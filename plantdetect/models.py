...
class Search_Data(models.Model):
    ...
    prediction_accuracy = models.CharField(max_length=100,null=True,blank=True)
    result = models.CharField(max_length=100,null=True,blank=True)
    input_image = models.FileField(max_length=200,null=True)
    supplement_image = models.FileField(max_length=200,null=True)
    disease_name = models.FileField(max_length=200,null=True)
    supplement_name = models.FileField(max_length=200,null=True)
    buy_link = models.FileField(max_length=200, null=True)
    description = models.FileField(max_length=400, null=True)
    possible_steps = models.FileField(max_length=400, null=True)
    created = models.DateTimeField(auto_now=True,null=True)
